...
function SaveData() {
    ...
    var requestData = { piViewModel: piViewModel, piProducts: piProductList, piTaxes: piTaxList, piTerms: piTermList };
    $.ajax({
        url: "../PurchaseInvoice/AddEditPI",
        cache: false,
        type: "POST",
        dataType: "json",
        data: JSON.stringify(requestData),
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                setTimeout(
                  function () {
                      window.location.href = "../PurchaseInvoice/AddEditPI?invoiceId=" + data.trnId + "&AccessMode=2";
                  }, 2000);
