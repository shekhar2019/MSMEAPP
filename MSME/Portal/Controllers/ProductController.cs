...
namespace Portal.Controllers
{
    public class ProductController : BaseController
    {
        ...
        [ValidateRequest(true, UserInterfaceHelper.Add_Edit_Product, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        public ActionResult ListBuyerSellerProduct()
        {
            try
            {
        ...
        [HttpGet]
        public PartialViewResult GetBuyerSellerProductList(string productName, string productCode, string productShortDesc, string productFullDesc, int productTypeId, int productMainGroupId, string assemblyType, string brandName)
        {
            List<ProductViewModel> products = new List<ProductViewModel>();
            ProductBL productBL = new ProductBL();
            try
            {
                products = productBL.GetBuyerSellerProductList(productName, ContextUser.CompanyId, productCode, productShortDesc, productFullDesc, productTypeId, productMainGroupId, assemblyType, brandName);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        [HttpGet]
        public JsonResult GetBrandList(long ProductMainGroupId, long ProductSubGroupId, long ProductSubChildGroupId)
        {
            UOMBL uomBL = new UOMBL();
            List<BrandViewModel> BomList = new List<BrandViewModel>();
            try
            {
                BomList = uomBL.GetBrandList(ProductMainGroupId,ProductSubGroupId,ProductSubChildGroupId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        [HttpGet]
        public JsonResult GetItemList(long ProductMainGroupId, long ProductSubGroupId, long ProductSubChildGroupId)
        {
            UOMBL uomBL = new UOMBL();
            List<ProductItemViewModel> BomList = new List<ProductItemViewModel>();
            try
            {
                BomList = uomBL.GetItemList(ProductMainGroupId, ProductSubGroupId, ProductSubChildGroupId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        [HttpGet]
        public JsonResult GetUOMId(long productMainGroupId, long productSubGroupId, long productChildSubGroupId)
        {
            ProductBL prdBL = new ProductBL();
            int UOMId = 0;
            try
            {
                UOMId = prdBL.GetUOMId(productMainGroupId, productSubGroupId, productChildSubGroupId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        [HttpGet]
        public JsonResult GetUOMListforSpecification(long productMainGroupId, long productSubGroupId, long productChildSubGroupId, long ProductTechSpecId)
        {
            ProductBL prdBL = new ProductBL();
            List<UOMViewModel> uomList = new List<UOMViewModel>();
            try
            {
                uomList = prdBL.GetUOMListforSpecification(productMainGroupId, productSubGroupId, productChildSubGroupId, ProductTechSpecId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        [HttpGet]
        public JsonResult GetUOMAutoCompleteList(string searchTerm, bool IsSUM)
        {
            UOMBL uomBL = new UOMBL();
            List<UOMViewModel> uomList = new List<UOMViewModel>();
            try
            {
                uomList = uomBL.GetUOMAutoCompleteList(searchTerm, IsSUM);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
