...
namespace Portal.Controllers
{
    public class QuotationController : BaseController
    {
        ...
        public ActionResult AddEditQuotation(int quotationId = 0, int accessMode = 3)
        {
            try
            {
                if (quotationId != 0)
        ...
        public ActionResult AddEditQuotation(QuotationViewModel quotationViewModel, List<QuotationProductViewModel> quotationProducts, List<QuotationTaxViewModel> quotationTaxes, List<QuotationTermViewModel> quotationTerms)
        {
            ...
            try
            {
                if (quotationViewModel != null)
                {
                    ...
                    responseOut = quotationBL.AddEditQuotation(quotationViewModel, quotationProducts, quotationTaxes,quotationTerms);
                }
                else
                {
        ...
        [HttpPost]
        public PartialViewResult GetQuotationSOProductList(List<QuotationProductViewModel> quotationProducts, long quotationId)
        {
            QuotationBL quotationBL = new QuotationBL();
            try
            {
                if (quotationProducts == null)
                {
                    quotationProducts = quotationBL.GetQuotationSOProductList(quotationId);
                }
        ...
        [HttpPost]
        public PartialViewResult GetQuotationSOTaxList(List<QuotationTaxViewModel> quotationTaxes, long quotationId)
        {
            QuotationBL quotationBL = new QuotationBL();
            try
            {
                ...
                {
                    quotationTaxes = quotationBL.GetQuotationSOTaxList(quotationId);
                }
       ...
       public ActionResult Report(long quotationId,string reportType= "PDF")
        ...
        [ValidateRequest(true, UserInterfaceHelper.Add_RevisedQuotation, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        public ActionResult AddRevisedQuotation(int quotationId = 0, int accessMode = 3)
        {
            try
            { 
                if (quotationId != 0)
        ...
        [HttpPost]
        [ValidateRequest(true, UserInterfaceHelper.Add_RevisedQuotation, (int)AccessMode.AddAccess, (int)RequestMode.Ajax)]
        public ActionResult AddRevisedQuotation(QuotationViewModel quotationViewModel, List<QuotationProductViewModel> quotationProducts, List<QuotationTaxViewModel> quotationTaxes, List<QuotationTermViewModel> quotationTerms)
        {
            ResponseOut responseOut = new ResponseOut();
            QuotationBL quotationBL = new QuotationBL();
            try
            {
                if (quotationViewModel != null)
                {
                    ...
                    quotationViewModel.CompanyId = ContextUser.CompanyId;
                    quotationViewModel.FinYearId = Session[SessionKey.CurrentFinYear] != null ? ((FinYearViewModel)Session[SessionKey.CurrentFinYear]).FinYearId : DateTime.Now.Year;
                    responseOut = quotationBL.AddRevisedQuotation(quotationViewModel, quotationProducts, quotationTaxes, quotationTerms);
