...
namespace Portal.Core
{
    public class CostCenterBL
    {
        ...
        public List<CostCenterViewModel> GetCostCenterList(string costcenterName = "",int companyId = 0, string status = "")
        {
            List<CostCenterViewModel> costcenters = new List<CostCenterViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            { 
                DataTable dtCostCenters = sqlDbInterface.GetCostCenterList(costcenterName, companyId, status);
