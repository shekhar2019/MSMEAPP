...
namespace Portal.Core
{
    public class DepartmentBL
    {
        ...
        public List<DepartmentViewModel> GetDepartmentList(string departmentName = "", string departmentCode = "", string Status="", int companyId = 0)
        {
            List<DepartmentViewModel> departments = new List<DepartmentViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtdepartments = sqlDbInterface.GetDepartmentList(departmentName, departmentCode, Status, companyId);
