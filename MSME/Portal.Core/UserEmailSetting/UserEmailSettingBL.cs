   ...
   public class UserEmailSettingBL
    {
        ...
        public List<UserEmailSettingViewModel> GetUserEmailSettingList(string fullName="",string userName = "")
        {
            List<UserEmailSettingViewModel> users = new List<UserEmailSettingViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtusers = sqlDbInterface.GetUserEmailSettingList(fullName,userName);
