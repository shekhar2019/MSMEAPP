...
namespace Portal.Core
{
    public class DeliveryChallanRegisterBL
    {
        ...
        public List<DeliveryChallanViewModel> GetDeliveryChallanRegisterList(int customerId, int stateId, int shippingstateId, string fromDate, string toDate, int createdBy, int companyId, string sortBy, string sortOrder)
        {            
            List<DeliveryChallanViewModel> deliveryChallanViewModel = new List<DeliveryChallanViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtSOs = sqlDbInterface.GetDeliveryChallanRegisterList(customerId, stateId, shippingstateId, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), createdBy, companyId, sortBy, sortOrder);
