...
namespace Portal.Core
{
    public class ProductTypeBL
    {
        ...
        public List<ProductTypeViewModel> GetProductTypeList(string producttypeName = "", string producttypeCode = "", string Status = "")
        {
            List<ProductTypeViewModel> producttypes = new List<ProductTypeViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtProductTypes = sqlDbInterface.GetProductTypeList(producttypeName, producttypeCode, Status);
