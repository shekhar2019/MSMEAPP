  ...
  public  class VendorBL
    {
        ...
        public List<VendorViewModel> GetVendorList(string vendorName, string vendorCode, string mobileNo,  int companyId, string vendorStatus)
        {
            List<VendorViewModel> vendors = new List<VendorViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtVendors = sqlDbInterface.GetVendorList(vendorName, vendorCode, mobileNo, companyId, vendorStatus);
