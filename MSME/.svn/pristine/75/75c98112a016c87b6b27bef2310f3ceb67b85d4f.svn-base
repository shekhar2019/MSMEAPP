...
function SaveData()
{
    ...
    var companyViewModel = {
        CompanyId: hdnCompanyID.val(), CompanyName: txtCompanyName.val().trim(), ContactPersonName: txtContactPersonName.val().trim(),
        Phone: txtPhone.val().trim(), Email: txtEmail.val().trim(), Fax: txtFax.val().trim(), Website: txtWebSite.val().trim(),
        Address: txtAddress.val().trim(), City: txtCity.val().trim(), State: ddlState.val(), CountryId: ddlCountry.val(), ZipCode: txtPinCode.val().trim(),
        CompanyDesc: txtCompanyDesc.val().trim(), PANNo: txtPANNo.val().trim(), TINNo: txtTINNo.val().trim(), TanNo: "", ServiceTaxNo: txtServiceTaxNo.val().trim(),
