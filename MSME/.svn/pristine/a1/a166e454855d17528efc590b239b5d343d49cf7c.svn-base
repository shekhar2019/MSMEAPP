...
namespace Portal.Core
{
    public class CustomerTypeBL
    {
        ...
        public List<CustomerTypeViewModel> GetCustomerTypeList(string customertypeDesc = "", string Status = "")
        {
            List<CustomerTypeViewModel> customertypes = new List<CustomerTypeViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtCustomerTypes = sqlDbInterface.GetCustomerTypeList(customertypeDesc, Status);
