...
namespace Portal.Core
{
    public class RoleBL
    {
        ...
        public List<RoleViewModel> GetRoleList(string roleName = "", string roleDesc = "", string isAdmin = "", string Status="",int companyId=0)
        {
            List<RoleViewModel> roles = new List<RoleViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtRoles = sqlDbInterface.GetRoleList(roleName, roleDesc, isAdmin, Status, companyId);
