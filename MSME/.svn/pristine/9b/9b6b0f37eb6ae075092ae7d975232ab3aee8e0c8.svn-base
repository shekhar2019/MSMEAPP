...
namespace Portal.Core
{
    public class TermTemplateBL
    {
        ...
        public List<TermTemplateViewModel> GetTermTemplateList(string termtemplateName, int companyId, string status)
        {
            List<TermTemplateViewModel> termtemplates = new List<TermTemplateViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtTermTemplates = sqlDbInterface.GetTermTemplateList(termtemplateName, companyId, status);
