...
namespace Portal.Core
{
    public class QuotationRegisterBL
    {
        ...
        public List<QuotationViewModel> GetQuotationRegisterList(int customerId, int stateId, string fromDate, string toDate, int companyId, int createdBy, string sortBy, string sortOrder)
        {
            List<QuotationViewModel> quotations = new List<QuotationViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtQuotations = sqlDbInterface.GetQuotationRegisterList(customerId, stateId, Convert.ToDateTime(fromDate),Convert.ToDateTime(toDate), companyId, createdBy, sortBy, sortOrder);
