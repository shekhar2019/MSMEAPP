  ...
  public  class SLDetailBL
    {
        ...
        public List<SLDetailViewModel> GetSLDetailList(int SLTypeId = 0, int GLId = 0,int SLId=0,int FinYearId=0, int CompanyId = 0)
        {
            List<SLDetailViewModel> sLDetailList = new List<SLDetailViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtsL = sqlDbInterface.GetSLDetailList(SLTypeId,GLId,SLId,FinYearId,CompanyId);
