...
namespace Portal.Core
{
    public class MRNRegisterBL
    {
        ...
        public List<MRNViewModel> GetMRNRegisterList(int vendorId, int shippingstateId, string fromDate, string toDate, int companyId, int createdBy, string sortBy, string sortOrder)
        {
            List<MRNViewModel> mrns = new List<MRNViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtMRNs = sqlDbInterface.GetMRNRegisterList(vendorId, shippingstateId, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), companyId, createdBy, sortBy, sortOrder);
