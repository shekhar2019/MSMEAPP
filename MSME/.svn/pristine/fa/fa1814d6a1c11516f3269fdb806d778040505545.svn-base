...
namespace Portal.Core
{
    public class SLBL
    {
        ...
        public List<SLViewModel> GetSLList(string SLCode="", int SLTypeId=0, int CostCenterId=0, int CompanyId=0, string Status="")
        {
            List<SLViewModel> sLList = new List<SLViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtsL = sqlDbInterface.GetSLList(SLCode, SLTypeId, CostCenterId, CompanyId, Status);
